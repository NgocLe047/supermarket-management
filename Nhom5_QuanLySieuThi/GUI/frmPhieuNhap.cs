...
namespace Nhom5_QuanLySieuThi.GUI
{
    public partial class frmPhieuNhap : Form
    {
        ...
        {
            maPhieuNhap = frmNhapHang.maPhieuNhap;
            txtSoPN.Text = maPhieuNhap.ToString();
            //Khai báo câu lệnh SQL
            String sql = "Select * from CTPhieuNhap Where SoPhieuNhap =" + maPhieuNhap.ToString();
            String sql2 = "Select * from PhieuNhapHang Where SoPhieuNhap =" + maPhieuNhap.ToString();
            String sql3 = "Select * from NhanVien,PhieuNhapHang Where PhieuNhapHang.MaNV = NhanVien.MaNV And SoPhieuNhap =" + maPhieuNhap.ToString();
